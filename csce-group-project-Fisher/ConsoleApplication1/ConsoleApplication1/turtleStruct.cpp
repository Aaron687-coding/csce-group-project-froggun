...
Turtle::Turtle(SDL_Rect r, bool hiding, int dx, int dy, int moveTimer, SDL_Texture* tex)
    : rect(r), hiding(hiding), dx(dx), dy(dy), moveTimer(moveTimer), texture(tex), up(0), down(0), left(0), right(0), bulletTimer(0), facingRight(false) {}
...
void Turtle::fireBullet(std::vector<Bullet>& bullets, SDL_Renderer* renderer, SDL_Texture* bulletTexture) 
{
