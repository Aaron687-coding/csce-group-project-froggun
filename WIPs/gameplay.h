...
#include "bat/batClass.h"
#include "beetle/beetleClass.h"
...
public:
    ...
    void Update(float deltaTime) override {
        ...
        beetleState.Update(deltaTime);
        batState.Update(deltaTime);
        batState.setGun(shotgun);
        beetleState.setGun(shotgun);
    }
    ...
    void Render(SDL_Renderer* renderer) override {
        ...
        // Initialize beetle and bat states
        beetleState.Init(renderer, &frog, shotgun);
        batState.Init(renderer, &frog, shotgun);

        beetleState.Render(renderer);
        batState.Render(renderer);
